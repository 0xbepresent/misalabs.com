        ...
        <div class='row'>
            ...
            <div class='large-8 large-centered columns'>
                ...
                <p style="text-align: justify;">I'm Misa, 
                    ...
                    <br><br>
                    I've been working on Web for the last seven years and I love working with Back-end side. I like to contribute to open source.
                    <br><br>
        ...
        <div class='row'>
            <div class='row'>
                <div class='large-8 large-centered columns'>
                    <h1>Contact me</h1>
                    <hr class="line_black">
                    <p>I'm located in Mexico City so please, send me an <a href="mailto:hi@misalabs.com"> e-mail</a>. If you want to talk securely, <a href="/pgp">here is my public PGP key.</a>
                    <br>
