        ...
        <div class='row'>
            <div class='row'>
                <div class='large-8 large-centered columns'>
                    <h1>Contact me</h1>
                    <hr class="line_black">
                    <p>I'm located in Mexico City so please, send me an <a href="mailto:a_garmo@hotmail.com"> e-mail</a>. If you want to talk securely, <a href="/pgp">here is my public PGP key.</a>
                    <br>
